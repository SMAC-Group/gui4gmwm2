...
## Features
- Wavelet variance visualization
- GMWM model fitting 
- Summary tables for estimated parameters
- Kalman filter–ready transformed estimated parameters
- Library datasets and custom file uploads
